                ...
                while (($row = oci_fetch_array($sql, OCI_BOTH + OCI_RETURN_NULLS)) != false) {
                  ...
                  <tbody>
                    <tr>
                      ...
                      " ?>
                <button type="button" class="btn btn-danger del_m_row" data-toggle="modal" data-table="fahrzeuge" data-id=<?php echo $row[0] ?> data-users_id=<?php echo $row['USERS_ID'] ?>>delete</button>
