      ...
      <table class="table">
        <thead>
          <tr>
            ...
            <th scope="col">endpreis</th>
            
          </tr>
        </thead>
        <?php 
        $sql = "select f.modell,f.hersteller,k.name,k.surname,k.telefonummer,verkaufsdatum,endpreis from verkaeufe left join fahrzeuge f on f.id = fahrzeug_id left join kunden k on k.id = kunden_id";
